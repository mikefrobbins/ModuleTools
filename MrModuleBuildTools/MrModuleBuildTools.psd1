#
# Module manifest for module 'PSGet_MrModuleBuildTools'
#
...
RootModule = 'MrModuleBuildTools.psm1'
...
FunctionsToExport = 'Get-MrAST', 'Get-MrRequiredModule', 'Get-MrRequiredPSVersion', 
